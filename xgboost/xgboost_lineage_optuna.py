...
base_path = '/gpfs/bwfor/work/ws/hd_bm327-myeloma_standal_ws/phenotyping/uncorrected/xgboost/standard/lineage'
data_path = ('/gpfs/bwfor/work/ws/hd_bm327-myeloma_standal_ws/phenotyping/uncorrected/manual_phenotypes_standard_lineage.csv')
mapping_path = os.path.join(base_path, 'phenotype_label_mapping_lineage.csv')
...
def main():
    ...
    def objective(trial):
        ...
        for train_index, test_index in kf.split(X_train_val, y_train_val):
            ...
            model.fit(X_train, y_train, eval_set=[(X_val, y_val)], early_stopping_rounds=50, verbose=2, sample_weight=sample_weights)
